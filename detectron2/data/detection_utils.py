...
def build_complex_augmentation(cfg, is_train):
    augmentation = build_augmentation(cfg, is_train)
    # augmentation += [
    #     TT.RandomApply([TT.ColorJitter(0.4, 0.4, 0.2, 0.1)], p=0.5),
    #     TT.RandomGrayscale(p=0.2),
    #     TT.RandomApply([GaussianBlur([0.1, 2.0])], p=0.2),
    # ]
    augmentation += [
        T.ColorJitter(),
        T.RandomGrayscale(),
